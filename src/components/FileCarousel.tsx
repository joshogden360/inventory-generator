...
export function FileCarousel() {
  ...
  return (
    <div className="modal modal-open bg-black/80 backdrop-blur-sm" role="dialog">
      <div className="modal-box max-w-4xl w-11/12 max-h-[90vh] flex flex-col p-0 overflow-hidden bg-gray-800 border border-gray-600">
        ...
        <div className="flex flex-col md:flex-row flex-1 overflow-hidden">
          <div className="md:w-2/3 flex flex-col p-4 border-b md:border-b-0 md:border-r border-gray-700 flex-shrink-0 md:overflow-y-auto">
            <div className="aspect-video bg-black rounded-lg overflow-hidden mb-3 shadow-inner flex items-center justify-center border border-gray-600">
              {currentImage ? (
                <img 
            ...
            {currentImage && (
              <div className="space-y-2">
                <h3 className="font-semibold text-lg truncate text-white" title={currentImage.name}>{currentImage.name}</h3>
                ...
                <div className="flex flex-wrap items-center gap-2 pt-2">
                  <button
                    ...
                    className="btn bg-blue-600 hover:bg-blue-700 text-white border-blue-600 btn-sm gap-2"
                  >
                  ...
                  <button
                    ...
                    className="btn bg-red-600 hover:bg-red-700 text-white border-red-600 btn-sm gap-2"
                  >
          ...
          <div className="md:w-1/3 p-4 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-600 scrollbar-track-gray-800 flex-1">
        ...
        <div className="flex items-center justify-between p-3 border-t border-gray-700 flex-shrink-0">
          <button
            ...
            className="btn btn-ghost btn-sm gap-2 text-white hover:bg-gray-700 disabled:text-gray-500"
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
